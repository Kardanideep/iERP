        ...
        {featuresData.items.slice(0, 6).map((feature, index) => {
          ...
          return (
            <div 
              ...
              className="group relative flex flex-col gap-6 rounded-4xl border border-white/5 bg-[#0e1214] p-10 transition-all duration-700 hover:-translate-y-4 overflow-hidden shadow-2xl"
            >
              ...
              <div className="relative z-10">
                <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-3xl bg-white/5 text-premium-brown shadow-xl transition-all duration-700 group-hover:bg-premium-brown group-hover:text-white group-hover:scale-110 group-hover:rotate-6">
                  {IconComponent && <IconComponent size={40} strokeWidth={1.5} />}
                </div>
                
                <h3 className="mb-4 text-3xl font-black tracking-tight text-premium-cream transition-colors duration-500 group-hover:text-premium-tan">
                  {feature.title}
                </h3>
                
                <p className="text-lg leading-relaxed text-premium-tan/60 transition-colors duration-500 group-hover:text-premium-tan/90">
                  {feature.details}
                </p>
              </div>
            </div>
